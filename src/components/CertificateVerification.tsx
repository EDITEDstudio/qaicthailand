    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="bg-gradient-to-br from-gray-900 to-slate-800 rounded-[2rem] p-8 md:p-10 text-white relative overflow-hidden shadow-xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8 pt-6 border-t border-white/10">
          <div className="space-y-1">
            <span className="text-xs text-gray-400 font-sans">{t('รหัสรับรองทั้งหมด', 'Registry Database Records')}</span>
          ...
          <div className="space-y-1">
            <span className="text-xs text-gray-400 font-sans">{t('ผ่านการรับรองแล้ว (Active)', 'Active Certified Clients')}</span>
          ...
          <div className="space-y-1">
            <span className="text-xs text-gray-400 font-sans">{t('กลุ่มสินค้าเกษตร มกษ. (ACFS)', 'Thai Agricultural TAS')}</span>
          ...
          <div className="space-y-1">
            <span className="text-xs text-gray-400 font-sans">{t('อัตราความน่าเชื่อถือระบบ', 'Validation Guarantee')}</span>
      ...
      <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-gray-100 shadow-sm space-y-6">
        ...
        <div className="space-y-4 font-sans">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="relative w-full md:max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-3 text-xs bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white font-sans transition-all placeholder:text-gray-400 shadow-inner"
              />
              {searchQuery && (
                <button 
                ...
                >
                  <XCircle className="w-4 h-4 text-gray-400 hover:text-gray-600 cursor-pointer" />
                </button>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 overflow-x-auto py-1 invisible-scrollbar">
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider font-sans whitespace-nowrap mr-1">
        ...
        {filteredClients.length > 0 ? (
            ...
            {filteredClients.map((client) => {
              ...
              return (
                <div
                  ...
                  className="group bg-white rounded-3xl border border-gray-100 hover:border-blue-200 hover:shadow-xl hover:shadow-gray-200/40 transition-all duration-300 p-5 flex flex-col justify-between cursor-pointer relative overflow-hidden"
                >
                  ...
                  <div className="flex justify-between items-start gap-2 mb-4">
                    ...
                    <span className="text-[10px] font-bold font-mono text-gray-400 bg-gray-50 px-2 py-0.5 rounded border">
                      {client.category}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="text-xs text-gray-400 font-sans font-bold flex items-center gap-1">
                      <Tag className="w-3.5 h-3.5 text-blue-500" />
                      <span>{client.standard}</span>
                    </div>

                    <h4 className="font-display font-bold text-gray-900 group-hover:text-blue-600 transition-colors text-sm line-clamp-1 leading-snug">
                    ...
                    {/* Meta values */}
                    <div className="grid grid-cols-2 gap-2 pt-3 border-t border-gray-50 text-[10.5px] text-gray-500 font-sans">
          ...
          <div className="py-20 text-center border-2 border-dashed border-gray-150 rounded-3xl max-w-xl mx-auto space-y-4">
            ...
            <div className="space-y-1">
              <h4 className="font-display font-bold text-gray-700">{t('ไม่พบบันทึกตรงตามเงื่อนไขค้นหา', 'No Certified Records Match')}</h4>
      ...
      <div className="bg-gray-50 border border-gray-200/60 p-6 md:p-8 rounded-[2.5rem] relative overflow-hidden">
        ...
        <div className="max-w-3xl space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500 font-sans max-w-2xl leading-relaxed">
              {t(
          ...
          <form onSubmit={handleMintSandboxCert} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
            <div className="md:col-span-2 space-y-1.5">
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest font-sans block">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-blue-500 font-sans"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full px-3 py-3 bg-white border border-gray-200 rounded-xl text-xs focus:outline-none font-sans"
              >
      ...
      {renewalClient && (
        <div className="fixed inset-0 z-[110] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl w-full max-w-lg p-6 md:p-8 border border-gray-100 shadow-2xl relative animate-scaleIn">
            ...
            <div className="flex items-center justify-between border-b pb-4 mb-6">
              ...
              <button 
                ...
                className="p-1.5 bg-gray-100 rounded-full text-gray-400 hover:text-gray-900 cursor-pointer"
              >
                <XCircle className="w-5 h-5" />
              </button>
            </div>
            ...
            {isRenewalSubmitted ? (
              <div className="text-center py-8 space-y-4">
                ...
                <div className="space-y-2">
                  <h4 className="font-display font-bold text-gray-900 text-base">{t('บันทึกคำขอต่ออายุด่วนเสร็จสมบูรณ์แล้ว!', 'Renewal Ticket Created Successfully!')}</h4>
              ...
              <form onSubmit={submitRenewalRequest} className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest font-sans block">{t('ชื่อผู้ลงประสานงาน', 'Your Full Name')}</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest font-sans block">{t('เบอร์โทรศัพท์ติดต่อประสานงาน', 'Direct phone number')}</label>
                    <div className="relative">
                      <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest font-sans block">{t('อีเมลสำหรับยื่นข้อเสนอพิเศษ', 'Contact Email address')}</label>
                    <div className="relative">
                      <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest font-sans block">{t('รายละเอียดเพิ่มเติม', 'Additional requirements')}</label>
                  <textarea
