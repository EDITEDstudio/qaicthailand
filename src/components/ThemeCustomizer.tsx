...
export default function ThemeCustomizer({ settings, onChange }: ThemeCustomizerProps) {
 ...
 className="flex items-center gap-2 px-4 py-3 rounded-full bg-white/40 backdrop-blur-[35px] border border-white/40 shadow-[inset_0_1.5px_0_rgba(255,255,255,0.4)] dark:bg-slate-900/40 dark:border-white/20 dark:shadow-[inset_0_1.5px_0_rgba(255,255,255,0.2)] text-gray-900 dark:text-white border shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer text-xs uppercase tracking-wider font-semibold font-display"
 >
 ...
 <div
 id="customizer-panel"
 className="absolute bottom-16 right-0 w-80 p-6 rounded-2xl bg-white/40 backdrop-blur-[35px] border border-white/40 shadow-[inset_0_1.5px_0_rgba(255,255,255,0.4)] dark:bg-slate-900/40 dark:border-white/20 dark:shadow-[inset_0_1.5px_0_rgba(255,255,255,0.2)] text-gray-900 dark:text-white shadow-2xl border animate-in fade-in slide-in-from-bottom-4 duration-200"
 >
 <div className="flex justify-between items-center mb-5 border-b border-gray-100 pb-3">
 <h3 className="font-display font-bold text-sm tracking-wide text-gray-800 dark:text-slate-100 uppercase flex items-center gap-1.5">
 <Sliders className="w-4 h-4 text-blue-600" />
 {settings.lang === 'TH' ? 'ปรับแต่งการแสดงผล' : 'Aesthetic Settings'}
 </h3>
 <button
 onClick={() => setIsOpen(false)}
 className="text-gray-600 dark:text-slate-500 hover:text-gray-800 dark:text-slate-300 font-sans text-xs"
 >
 ✕
 </button>
 </div>
 ...
 {/* Theme Selector */}
 <div className="mb-4">
 <span className="text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-slate-500 block mb-2">
 ...
 : 'border-gray-200 bg-gray-50/50 hover:bg-gray-100/50 text-gray-800 dark:text-slate-300'
 }`}
 >
 ...
 {/* Font Resizing */}
 <div className="mb-4">
 <span className="text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-slate-500 block mb-2 flex items-center gap-1">
 <Type className="w-3.5 h-3.5 text-gray-600 dark:text-slate-500" />
 ...
 ? ' bg-white/40 backdrop-blur-[35px] border border-white/40 shadow-[inset_0_1.5px_0_rgba(255,255,255,0.4)] dark:bg-slate-900/40 dark:border-white/20 dark:shadow-[inset_0_1.5px_0_rgba(255,255,255,0.2)] font-semibold text-gray-900 dark:text-white shadow-sm'
 ...
 <div>
 <span className="text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-slate-500 block mb-2 flex items-center gap-1">
 <Globe className="w-3.5 h-3.5 text-gray-600 dark:text-slate-500" />
 ...
 : 'border-gray-200 text-gray-700 dark:text-slate-400 hover:bg-gray-50'
 }`}
 >
 <span>ภาษาไทย 🇹🇭</span>
