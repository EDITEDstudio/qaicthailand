...
export default function DiagnosticQuiz({ settings }: DiagnosticQuizProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-7 bg-white rounded-3xl border border-gray-100 p-6 shadow-sm flex flex-col justify-between min-h-[460px]">
        {!quizCompleted ? (
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3 border-b border-gray-100 pb-4">
              ...
              <div>
                <h3 className="font-display font-bold text-sm text-gray-900 tracking-wide uppercase">
            ...
            <div className="space-y-4">
              ...
              <h4 className="font-display font-bold text-base text-gray-800 leading-snug">
                    ...
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 text-xs rounded-xl border transition-all flex items-center justify-between cursor-pointer ${
                        isSelected
                          ...
                          : 'border-gray-200/80 hover:border-blue-200 hover:bg-gray-50/50 text-gray-600'
                      }`}
                    >
            ...
            <div className="flex justify-between items-center pt-4 border-t border-gray-100">
              <button
                ...
                className="text-xs font-semibold text-gray-400 hover:text-gray-600 cursor-pointer disabled:opacity-0"
              >
                ...
                >
                  ...
                  <div className="flex justify-between items-start gap-4">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="text-[11px] font-bold px-2 py-0.5 rounded bg-white text-gray-800 border border-gray-200">
                          {res.code}
                        </span>
                    ...
                    <div className="text-right">
                      <span className="text-[10px] text-gray-400 block uppercase font-sans font-bold">Match Score</span>
                  ...
                  <div className="mt-3 pt-2.5 border-t border-gray-250/20 grid grid-cols-1 md:grid-cols-2 gap-1.5">
                    {res.benefits.slice(0, 2).map((b, key) => (
                      <div key={key} className="flex gap-1.5 items-start text-[10px] text-gray-500 font-sans">
      ...
      <div className="lg:col-span-5 bg-white rounded-3xl border border-gray-100 p-6 shadow-sm flex flex-col justify-between min-h-[460px]">
        ...
        <div className="mt-5 border-t border-dashed border-gray-150 pt-4 space-y-4">
          <div className="bg-gray-50 p-4 rounded-2xl space-y-2.5 font-sans">
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block border-b border-gray-200 pb-1.5">
            ...
            <div className="space-y-1.5 text-xs text-gray-600">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-gray-900">{derivedMetrics.auditFee.toLocaleString()} THB</span>
              </div>
              <div className="flex justify-between">
                <span>{lang === 'TH' ? 'ค่าธรรมเนียมขึ้นทะเบียนอังกฤษ (Registrar fee)' : 'Accredited Registration Fee'}</span>
                <span className="font-semibold text-gray-900">{derivedMetrics.regFee.toLocaleString()} THB</span>
              </div>
              {includeTraining && (
          ...
          <div className="grid grid-cols-2 gap-3 text-center">
            <div className="bg-gray-50/50 p-2.5 rounded-xl border border-gray-100 flex flex-col justify-center">
              <div className="flex justify-center text-gray-500 mb-0.5">
                <Clock className="w-4 h-4 text-blue-600" />
              </div>
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block leading-none">Timeline</span>
              <span className="text-sm font-bold font-display text-gray-800 mt-1">
            ...
            <div className="bg-gray-50/50 p-2.5 rounded-xl border border-gray-100 flex flex-col justify-center">
              ...
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block leading-none">Auditors Reg</span>
              <span className="text-sm font-bold font-display text-gray-800 mt-1">
