...
export default function InfoSections({ settings, onTabChange }: InfoSectionsProps) {
 ...
 <section className="bg-white/40 backdrop-blur-[35px] border border-white/40 shadow-[inset_0_1.5px_0_rgba(255,255,255,0.4)] dark:bg-slate-900/40 dark:border-white/20 dark:shadow-[inset_0_1.5px_0_rgba(255,255,255,0.2)] rounded-[3rem] p-8 md:p-12 shadow-sm relative overflow-hidden">
